...
def parse_arguments(is_training: bool = True):
    ...
    parser.add_argument("--domain_batch_size", type=int, default=32, help="_")
    ...
    parser.add_argument("--domain_data", type=str, default="")
    parser.add_argument("--target_data", type=str, default="")
    parser.add_argument("--alpha_domain", type=float, default=1)
    parser.add_argument("--domain_test_train_spilt", type=float, default=0.9)
