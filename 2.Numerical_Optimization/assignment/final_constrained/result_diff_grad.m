...
[xk, fk, gradfk_norm, deltaxk_norm, k, xseq, btseq] = ...
    constr_steepest_desc_bcktrck_diff(x0, f, ...
    kmax, tolgrad, c1, rho, btmax, gamma, tolx, Pi_X, k_h, n);
toc
